...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
      ...
      <div class="layui-form layui-form-pane">
        <div class="layui-input-inline operator-div">
          <c:if test="${powers['ADD'] }">
            <button id="add" class="layui-btn layui-btn-normal"><i class="layui-icon layui-icon-add-circle-fine"></i>添加
            </button>
          </c:if>
    ...
    <script type="text/html" id="fixedStatusTpl">
      {{# if(d.fixedStatus == "1"){ }}<span class="layui-badge layui-bg-custom-lightgreen">固定</span>
      {{# }else if(d.fixedStatus == "0"){ }}<span class="layui-badge layui-bg-gray">不固定</span>
      {{# }else{ }}{{ d.fixedStatus }}{{# } }}
    </script>
    ...
    <script type="text/javascript" src="${ctx }/js/system/white-ip.js?v=0.0.1.1"></script>
  </body>
</html>