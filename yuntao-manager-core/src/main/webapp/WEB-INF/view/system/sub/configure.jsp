                  ...
                  <tr>
                    ...
                    <td align="left">
                      <c:forEach var="item3" items="${item2.modulePowers }" varStatus="status3">
                        <input type="checkbox" id="module_power_${item2.moduleId }_${item3.mpId }" value="${item2.moduleCode }.${item3.powerItem }" <c:if test="${!empty item3.hasPower }">checked</c:if> style="width:16px;height:16px;">${item3.aliasName }
                      </c:forEach>
                    </td>
