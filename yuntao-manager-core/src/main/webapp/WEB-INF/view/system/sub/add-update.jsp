      ...
      <form class="layui-form layui-form-pane">
          ...
          <div class="layui-input-block">
            <c:choose>
              <c:when test="${cmd eq 'add' }">
                <input type="text" name="operatorNo" required lay-verify="letternumline" lay-data-length="3-16" lay-null-msg="请输入子账号" lay-error-msg="子账号由3-16位字母数字下划线组成" placeholder="请输入子账号" class="layui-input" autocomplete="off">
              </c:when>
              <c:otherwise>
                <input type="text" name="operatorNo" required readonly lay-verify="required" value="${operator.operatorNo }" class="layui-input" autocomplete="off">
              </c:otherwise>
            </c:choose>
          </div>
        </div>
        ...
        <c:if test="${cmd eq 'add' and sessionScope.loginUser.roleId eq '0' }">
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="masterNo" required lay-verify="letternumline" lay-data-length="3-16" lay-null-msg="请输入主账号" lay-error-msg="主账号由3-16位字母数字下划线组成" value="${sessionScope.loginUser.loginNo }" placeholder="请输入主账号" class="layui-input" autocomplete="off">
            </div>
          </div>
        </c:if>
        ...
        <c:if test="${cmd eq 'update' }">
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="masterNo" required readonly lay-verify="required" value="${operator.masterNo }" class="layui-input" autocomplete="off">
            </div>
          </div>
        </c:if>
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" name="email" lay-verify="email" lay-ignore="ignore" value="${operator.email }" placeholder="请输入子账号邮箱账号" class="layui-input" autocomplete="off">
          </div>
        </div>
        <div class="layui-form-item">
          <label class="layui-form-label">电话号码</label>
          <div class="layui-input-block">
            <input type="text" name="tel" value="${operator.tel }" placeholder="请输入子账号电话号码" class="layui-input" autocomplete="off">
          </div>
        </div>
