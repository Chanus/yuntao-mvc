/*
 ...
 Source Schema         : yuntao-manager-core
...
CREATE TABLE `sys_dict_item` (
  ...
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `dict_code` (`dict_code`,`item_code`) USING BTREE
...
CREATE TABLE `sys_log` (
  ...
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `operate_time` (`operate_time`,`operate_no`) USING BTREE
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_module` VALUES (10, 0, '系统管理', '', '10', '1', '1', '0', '0', 'layui-icon layui-icon-set', '', '', '1', '2018-09-02 20:40:37', '2020-03-19 13:50:09');
INSERT INTO `sys_module` VALUES (99, 0, '非菜单URL管理', '', '99', '0', '0', '0', '0', '', '', '系统中非菜单的请求URL', '1', '2018-09-02 20:40:37', '2020-03-16 23:52:43');
INSERT INTO `sys_module` VALUES (1001, 10, '权限项管理', 'system/power/main.do', '1001', '1', '1', '1', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-19 20:45:46');
INSERT INTO `sys_module` VALUES (1002, 10, '模块管理', 'system/module/main.do', '1002', '1', '1', '1', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-19 13:29:56');
INSERT INTO `sys_module` VALUES (1003, 10, '模块权限配置', 'system/modulepower/main.do', '1003', '1', '1', '1', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-16 23:51:06');
INSERT INTO `sys_module` VALUES (1004, 10, '角色管理', 'system/role/main.do', '1004', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-19 13:50:15');
INSERT INTO `sys_module` VALUES (1005, 10, '操作员管理', 'system/operator/main.do', '1006', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-16 23:51:07');
INSERT INTO `sys_module` VALUES (1006, 10, '子账号管理', 'system/sub/main.do', '1007', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-16 23:51:08');
INSERT INTO `sys_module` VALUES (1007, 10, '系统参数配置', 'system/param/main.do', '1008', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-16 23:51:09');
INSERT INTO `sys_module` VALUES (1008, 10, 'IP白名单管理', 'system/whiteip/main.do', '1010', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-16 23:51:09');
INSERT INTO `sys_module` VALUES (1009, 10, '操作日志', 'system/log/main.do', '1012', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2018-09-02 20:40:37', '2020-03-16 23:51:10');
INSERT INTO `sys_module` VALUES (1010, 10, '代码生成工具', 'system/code/main.do', '1013', '1', '1', '1', '1', 'layui-icon layui-icon-form', '0', '', '1', '2018-10-30 20:46:00', '2020-03-16 23:51:10');
INSERT INTO `sys_module` VALUES (1011, 10, '组织机构管理', 'system/organization/main.do', '1005', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2019-05-06 21:08:53', '2020-03-16 23:51:11');
INSERT INTO `sys_module` VALUES (1012, 10, '数据字典管理', 'system/dict/main.do', '1009', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2019-06-07 12:37:41', '2020-03-16 23:51:12');
INSERT INTO `sys_module` VALUES (1013, 10, '定时任务管理', 'system/job/main.do', '1011', '1', '1', '0', '0', 'layui-icon layui-icon-form', '0', '', '1', '2020-04-12 19:24:21', '2020-04-12 19:24:21');
...
INSERT INTO `sys_module_power` VALUES (54, 1013, 'VIEW', '浏览', '2020-04-12 19:28:22', '2020-04-12 19:28:22');
INSERT INTO `sys_module_power` VALUES (55, 1013, 'ADD', '添加', '2020-04-12 19:28:22', '2020-04-12 19:28:22');
INSERT INTO `sys_module_power` VALUES (56, 1013, 'DELETE', '删除', '2020-04-12 19:28:22', '2020-04-12 19:28:22');
INSERT INTO `sys_module_power` VALUES (57, 1013, 'UPDATE', '编辑', '2020-04-12 19:28:22', '2020-04-12 19:28:22');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_module_power_method` VALUES (1, 1, 'pers.chanus.yuntao.manager.controller.LoginController', '/login', '2018-09-04 15:45:19', '2018-09-08 14:53:11');
INSERT INTO `sys_module_power_method` VALUES (2, 1, 'pers.chanus.yuntao.manager.controller.LoginController', '/rsa-public-key', '2018-09-04 15:45:19', '2018-09-08 14:53:10');
INSERT INTO `sys_module_power_method` VALUES (3, 1, 'pers.chanus.yuntao.manager.controller.LoginController', '/verify-code', '2018-09-04 15:45:19', '2018-09-08 14:53:09');
INSERT INTO `sys_module_power_method` VALUES (4, 1, 'pers.chanus.yuntao.manager.controller.LoginController', '/relogin', '2018-09-04 15:45:19', '2018-09-08 14:53:07');
INSERT INTO `sys_module_power_method` VALUES (5, 1, 'pers.chanus.yuntao.manager.controller.LoginController', '/logout.do', '2018-09-04 15:45:19', '2018-09-08 14:53:06');
INSERT INTO `sys_module_power_method` VALUES (6, 2, 'pers.chanus.yuntao.manager.controller.IndexController', '/index/index.do', '2018-09-04 15:45:19', '2018-09-08 14:53:04');
INSERT INTO `sys_module_power_method` VALUES (7, 2, 'pers.chanus.yuntao.manager.controller.IndexController', '/index/reload-authority.do', '2018-09-04 15:45:19', '2018-09-08 14:52:47');
INSERT INTO `sys_module_power_method` VALUES (8, 2, 'pers.chanus.yuntao.manager.controller.IndexController', '/index/user/operator-info.do', '2018-09-04 15:45:19', '2018-09-08 14:52:45');
INSERT INTO `sys_module_power_method` VALUES (9, 2, 'pers.chanus.yuntao.manager.controller.IndexController', '/index/user/update-own-password.do', '2018-09-04 15:45:19', '2018-09-08 14:52:43');
INSERT INTO `sys_module_power_method` VALUES (10, 3, 'pers.chanus.yuntao.manager.controller.PowerController', '/system/power/main.do', '2018-09-08 14:51:38', '2018-09-08 15:52:13');
INSERT INTO `sys_module_power_method` VALUES (11, 3, 'pers.chanus.yuntao.manager.controller.PowerController', '/system/power/list.do', '2018-09-08 14:51:38', '2018-09-08 15:52:15');
INSERT INTO `sys_module_power_method` VALUES (12, 4, 'pers.chanus.yuntao.manager.controller.PowerController', '/system/power/add.do', '2018-09-08 14:51:38', '2018-09-08 16:47:58');
INSERT INTO `sys_module_power_method` VALUES (13, 5, 'pers.chanus.yuntao.manager.controller.PowerController', '/system/power/delete.do', '2018-09-08 14:51:38', '2018-09-08 16:48:35');
INSERT INTO `sys_module_power_method` VALUES (14, 6, 'pers.chanus.yuntao.manager.controller.PowerController', '/system/power/update.do', '2018-09-08 14:51:38', '2018-09-08 16:48:48');
INSERT INTO `sys_module_power_method` VALUES (15, 7, 'pers.chanus.yuntao.manager.controller.PowerController', '/system/power/priority.do', '2018-09-08 14:51:38', '2018-09-08 16:48:13');
INSERT INTO `sys_module_power_method` VALUES (16, 8, 'pers.chanus.yuntao.manager.controller.ModuleController', '/system/module/main.do', '2018-09-08 16:47:40', '2018-09-08 16:47:40');
INSERT INTO `sys_module_power_method` VALUES (17, 8, 'pers.chanus.yuntao.manager.controller.ModuleController', '/system/module/list.do', '2018-09-08 16:47:40', '2018-09-08 16:50:01');
INSERT INTO `sys_module_power_method` VALUES (18, 8, 'pers.chanus.yuntao.manager.controller.ModuleController', '/system/module/tree.do', '2018-09-08 16:47:40', '2018-09-08 16:50:14');
INSERT INTO `sys_module_power_method` VALUES (19, 9, 'pers.chanus.yuntao.manager.controller.ModuleController', '/system/module/add.do', '2018-09-08 16:47:40', '2018-09-08 16:51:59');
INSERT INTO `sys_module_power_method` VALUES (20, 10, 'pers.chanus.yuntao.manager.controller.ModuleController', '/system/module/delete.do', '2018-09-08 16:47:40', '2018-09-08 16:53:10');
INSERT INTO `sys_module_power_method` VALUES (21, 11, 'pers.chanus.yuntao.manager.controller.ModuleController', '/system/module/update.do', '2018-09-08 16:47:40', '2018-09-08 16:52:42');
INSERT INTO `sys_module_power_method` VALUES (22, 12, 'pers.chanus.yuntao.manager.controller.ModuleController', '/system/module/priority.do', '2018-09-08 16:47:40', '2018-09-08 16:53:21');
INSERT INTO `sys_module_power_method` VALUES (23, 13, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/main.do', '2018-09-08 21:05:29', '2018-09-08 21:05:29');
INSERT INTO `sys_module_power_method` VALUES (24, 13, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/list.do', '2018-09-08 21:05:29', '2018-09-08 21:05:29');
INSERT INTO `sys_module_power_method` VALUES (25, 13, 'pers.chanus.yuntao.manager.controller.ModuleController', '/system/module/modules.do', '2018-09-08 21:05:29', '2018-09-08 21:05:29');
INSERT INTO `sys_module_power_method` VALUES (26, 14, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/add.do', '2018-09-08 21:05:29', '2018-09-08 21:05:29');
INSERT INTO `sys_module_power_method` VALUES (27, 15, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/delete.do', '2018-09-08 21:05:29', '2018-09-08 21:05:29');
INSERT INTO `sys_module_power_method` VALUES (28, 16, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/update.do', '2018-09-08 21:05:29', '2018-09-08 21:05:29');
INSERT INTO `sys_module_power_method` VALUES (29, 17, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/method-main.do', '2018-09-08 21:44:14', '2018-09-08 21:44:14');
INSERT INTO `sys_module_power_method` VALUES (30, 17, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/method-list.do', '2018-09-08 21:44:14', '2018-09-08 21:44:14');
INSERT INTO `sys_module_power_method` VALUES (31, 17, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/urls.do', '2018-09-08 21:44:14', '2018-09-08 21:44:14');
INSERT INTO `sys_module_power_method` VALUES (32, 17, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/method-add.do', '2018-09-08 21:44:14', '2018-09-08 21:44:14');
INSERT INTO `sys_module_power_method` VALUES (33, 17, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/method-delete.do', '2018-09-08 21:44:14', '2018-09-08 21:44:14');
INSERT INTO `sys_module_power_method` VALUES (34, 17, 'pers.chanus.yuntao.manager.controller.ModulePowerController', '/system/modulepower/method-update.do', '2018-09-08 21:44:14', '2018-09-08 21:46:02');
INSERT INTO `sys_module_power_method` VALUES (35, 18, 'pers.chanus.yuntao.manager.controller.RoleController', '/system/role/main.do', '2018-09-08 22:48:05', '2018-09-08 22:48:05');
INSERT INTO `sys_module_power_method` VALUES (36, 18, 'pers.chanus.yuntao.manager.controller.RoleController', '/system/role/list.do', '2018-09-08 22:48:09', '2018-09-08 22:48:09');
INSERT INTO `sys_module_power_method` VALUES (37, 18, 'pers.chanus.yuntao.manager.controller.RoleController', '/system/role/tree.do', '2018-09-08 22:48:14', '2018-09-08 22:48:14');
INSERT INTO `sys_module_power_method` VALUES (38, 18, 'pers.chanus.yuntao.manager.controller.RoleController', '/system/role/list-role-module-power.do', '2018-09-08 22:48:48', '2018-09-08 22:48:48');
INSERT INTO `sys_module_power_method` VALUES (39, 19, 'pers.chanus.yuntao.manager.controller.RoleController', '/system/role/add.do', '2018-09-08 22:49:07', '2018-09-08 22:49:07');
INSERT INTO `sys_module_power_method` VALUES (40, 20, 'pers.chanus.yuntao.manager.controller.RoleController', '/system/role/delete.do', '2018-09-08 22:49:18', '2018-09-08 22:49:18');
INSERT INTO `sys_module_power_method` VALUES (41, 21, 'pers.chanus.yuntao.manager.controller.RoleController', '/system/role/update.do', '2018-09-08 22:49:28', '2018-09-08 22:49:28');
INSERT INTO `sys_module_power_method` VALUES (42, 22, 'pers.chanus.yuntao.manager.controller.RoleController', '/system/role/grant.do', '2018-09-08 22:49:46', '2018-09-08 22:49:46');
INSERT INTO `sys_module_power_method` VALUES (43, 23, 'pers.chanus.yuntao.manager.controller.OperatorController', '/system/operator/main.do', '2018-09-09 12:01:49', '2018-09-09 12:01:49');
INSERT INTO `sys_module_power_method` VALUES (44, 23, 'pers.chanus.yuntao.manager.controller.OperatorController', '/system/operator/list.do', '2018-09-09 12:01:53', '2018-09-09 12:01:53');
INSERT INTO `sys_module_power_method` VALUES (45, 23, 'pers.chanus.yuntao.manager.controller.OperatorController', '/system/operator/tree.do', '2018-09-09 12:01:58', '2018-09-09 12:01:58');
INSERT INTO `sys_module_power_method` VALUES (46, 24, 'pers.chanus.yuntao.manager.controller.OperatorController', '/system/operator/add.do', '2018-09-09 12:02:11', '2018-09-09 12:02:11');
INSERT INTO `sys_module_power_method` VALUES (47, 25, 'pers.chanus.yuntao.manager.controller.OperatorController', '/system/operator/delete.do', '2018-09-09 12:02:28', '2018-09-09 12:02:28');
INSERT INTO `sys_module_power_method` VALUES (48, 26, 'pers.chanus.yuntao.manager.controller.OperatorController', '/system/operator/update.do', '2018-09-09 12:02:39', '2018-09-09 12:02:39');
INSERT INTO `sys_module_power_method` VALUES (49, 27, 'pers.chanus.yuntao.manager.controller.OperatorController', '/system/operator/password.do', '2018-09-09 12:02:54', '2018-09-09 12:02:54');
INSERT INTO `sys_module_power_method` VALUES (50, 28, 'pers.chanus.yuntao.manager.controller.SubController', '/system/sub/main.do', '2018-09-09 15:04:10', '2018-09-09 15:04:10');
INSERT INTO `sys_module_power_method` VALUES (51, 28, 'pers.chanus.yuntao.manager.controller.SubController', '/system/sub/list.do', '2018-09-09 15:04:15', '2018-09-09 15:04:15');
INSERT INTO `sys_module_power_method` VALUES (52, 29, 'pers.chanus.yuntao.manager.controller.SubController', '/system/sub/add.do', '2018-09-09 15:04:32', '2018-09-09 15:04:32');
INSERT INTO `sys_module_power_method` VALUES (53, 30, 'pers.chanus.yuntao.manager.controller.SubController', '/system/sub/delete.do', '2018-09-09 15:04:43', '2018-09-09 15:04:43');
INSERT INTO `sys_module_power_method` VALUES (54, 31, 'pers.chanus.yuntao.manager.controller.SubController', '/system/sub/update.do', '2018-09-09 15:04:57', '2018-09-09 15:04:57');
INSERT INTO `sys_module_power_method` VALUES (55, 32, 'pers.chanus.yuntao.manager.controller.SubController', '/system/sub/configure.do', '2018-09-09 15:05:22', '2018-09-09 15:05:22');
INSERT INTO `sys_module_power_method` VALUES (56, 33, 'pers.chanus.yuntao.manager.controller.SubController', '/system/sub/password.do', '2018-09-09 15:05:31', '2018-09-09 15:05:31');
INSERT INTO `sys_module_power_method` VALUES (57, 34, 'pers.chanus.yuntao.manager.controller.ParamController', '/system/param/main.do', '2018-09-09 17:01:49', '2018-09-09 17:01:49');
INSERT INTO `sys_module_power_method` VALUES (58, 34, 'pers.chanus.yuntao.manager.controller.ParamController', '/system/param/list.do', '2018-09-09 17:01:53', '2018-09-09 17:01:53');
INSERT INTO `sys_module_power_method` VALUES (59, 34, 'pers.chanus.yuntao.manager.controller.ParamController', '/system/param/reload-param.do', '2018-09-09 17:02:05', '2018-09-09 17:02:05');
INSERT INTO `sys_module_power_method` VALUES (60, 35, 'pers.chanus.yuntao.manager.controller.ParamController', '/system/param/add.do', '2018-09-09 17:02:37', '2018-09-09 17:02:37');
INSERT INTO `sys_module_power_method` VALUES (61, 36, 'pers.chanus.yuntao.manager.controller.ParamController', '/system/param/delete.do', '2018-09-09 17:02:48', '2018-09-09 17:02:48');
INSERT INTO `sys_module_power_method` VALUES (62, 37, 'pers.chanus.yuntao.manager.controller.ParamController', '/system/param/update.do', '2018-09-09 17:03:01', '2018-09-09 17:03:01');
INSERT INTO `sys_module_power_method` VALUES (63, 38, 'pers.chanus.yuntao.manager.controller.ParamController', '/system/param/priority.do', '2018-09-09 17:03:13', '2018-09-09 17:03:13');
INSERT INTO `sys_module_power_method` VALUES (64, 39, 'pers.chanus.yuntao.manager.controller.WhiteIpController', '/system/whiteip/main.do', '2018-09-09 17:03:32', '2018-09-09 17:03:32');
INSERT INTO `sys_module_power_method` VALUES (65, 39, 'pers.chanus.yuntao.manager.controller.WhiteIpController', '/system/whiteip/list.do', '2018-09-09 17:03:35', '2018-09-09 17:03:35');
INSERT INTO `sys_module_power_method` VALUES (66, 40, 'pers.chanus.yuntao.manager.controller.WhiteIpController', '/system/whiteip/add.do', '2018-09-09 17:03:45', '2018-09-09 17:03:45');
INSERT INTO `sys_module_power_method` VALUES (67, 41, 'pers.chanus.yuntao.manager.controller.WhiteIpController', '/system/whiteip/delete.do', '2018-09-09 17:03:57', '2018-09-09 17:03:57');
INSERT INTO `sys_module_power_method` VALUES (68, 42, 'pers.chanus.yuntao.manager.controller.WhiteIpController', '/system/whiteip/update.do', '2018-09-09 17:04:11', '2018-09-09 17:04:11');
INSERT INTO `sys_module_power_method` VALUES (69, 43, 'pers.chanus.yuntao.manager.controller.LogController', '/system/log/main.do', '2018-09-09 17:04:47', '2018-09-09 17:04:47');
INSERT INTO `sys_module_power_method` VALUES (70, 43, 'pers.chanus.yuntao.manager.controller.LogController', '/system/log/list.do', '2018-09-09 17:04:51', '2018-09-09 17:04:51');
INSERT INTO `sys_module_power_method` VALUES (71, 43, 'pers.chanus.yuntao.manager.controller.LogController', '/system/log/content.do', '2018-09-09 17:04:54', '2018-09-09 17:04:54');
INSERT INTO `sys_module_power_method` VALUES (72, 2, 'pers.chanus.yuntao.manager.controller.IndexController', '/index/user/headimage.do', '2018-09-11 19:08:23', '2018-09-11 19:08:23');
INSERT INTO `sys_module_power_method` VALUES (73, 44, 'pers.chanus.yuntao.manager.controller.CodeGenerationController', '/system/code/main.do', '2018-10-30 20:49:02', '2018-10-30 21:40:43');
INSERT INTO `sys_module_power_method` VALUES (74, 44, 'pers.chanus.yuntao.manager.controller.CodeGenerationController', '/system/code/list.do', '2018-10-30 21:40:21', '2018-10-30 21:40:36');
INSERT INTO `sys_module_power_method` VALUES (75, 44, 'pers.chanus.yuntao.manager.controller.CodeGenerationController', '/system/code/table-column.do', '2018-10-30 22:05:40', '2018-10-30 22:05:40');
INSERT INTO `sys_module_power_method` VALUES (76, 45, 'pers.chanus.yuntao.manager.controller.CodeGenerationController', '/system/code/generate.do', '2018-11-09 14:57:56', '2018-11-09 14:57:56');
INSERT INTO `sys_module_power_method` VALUES (77, 45, 'pers.chanus.yuntao.manager.controller.CodeGenerationController', '/system/code/generate-download.do', '2018-11-09 15:10:28', '2018-11-09 15:10:28');
INSERT INTO `sys_module_power_method` VALUES (78, 2, 'pers.chanus.yuntao.manager.controller.LoginController', '/check-login.do', '2019-05-06 20:22:39', '2019-05-06 20:22:39');
INSERT INTO `sys_module_power_method` VALUES (79, 46, 'pers.chanus.yuntao.manager.controller.OrganizationController', '/system/organization/main.do', '2019-05-07 12:56:48', '2019-05-07 12:56:48');
INSERT INTO `sys_module_power_method` VALUES (80, 46, 'pers.chanus.yuntao.manager.controller.OrganizationController', '/system/organization/list.do', '2019-05-07 12:56:57', '2019-05-07 12:56:57');
INSERT INTO `sys_module_power_method` VALUES (81, 46, 'pers.chanus.yuntao.manager.controller.OrganizationController', '/system/organization/tree.do', '2019-05-07 12:57:07', '2019-05-07 12:57:07');
INSERT INTO `sys_module_power_method` VALUES (82, 47, 'pers.chanus.yuntao.manager.controller.OrganizationController', '/system/organization/add.do', '2019-05-07 14:14:13', '2019-05-07 14:14:13');
INSERT INTO `sys_module_power_method` VALUES (83, 48, 'pers.chanus.yuntao.manager.controller.OrganizationController', '/system/organization/delete.do', '2019-05-07 15:29:28', '2019-05-07 15:29:28');
INSERT INTO `sys_module_power_method` VALUES (84, 49, 'pers.chanus.yuntao.manager.controller.OrganizationController', '/system/organization/update.do', '2019-05-07 15:29:47', '2019-05-07 15:29:47');
INSERT INTO `sys_module_power_method` VALUES (85, 49, 'pers.chanus.yuntao.manager.controller.OrganizationController', '/system/organization/priority.do', '2019-05-07 16:44:44', '2019-05-07 16:44:44');
INSERT INTO `sys_module_power_method` VALUES (86, 50, 'pers.chanus.yuntao.manager.controller.DictController', '/system/dict/main.do', '2019-06-07 13:09:07', '2019-06-07 13:09:07');
INSERT INTO `sys_module_power_method` VALUES (87, 50, 'pers.chanus.yuntao.manager.controller.DictController', '/system/dict/list.do', '2019-06-07 13:09:07', '2019-06-07 13:09:07');
INSERT INTO `sys_module_power_method` VALUES (88, 51, 'pers.chanus.yuntao.manager.controller.DictController', '/system/dict/add.do', '2019-06-07 13:09:07', '2019-06-07 13:09:07');
INSERT INTO `sys_module_power_method` VALUES (89, 52, 'pers.chanus.yuntao.manager.controller.DictController', '/system/dict/delete.do', '2019-06-07 13:09:07', '2019-06-07 13:09:07');
INSERT INTO `sys_module_power_method` VALUES (90, 53, 'pers.chanus.yuntao.manager.controller.DictController', '/system/dict/update.do', '2019-06-07 13:09:07', '2019-06-07 15:26:41');
INSERT INTO `sys_module_power_method` VALUES (91, 50, 'pers.chanus.yuntao.manager.controller.DictItemController', '/system/dict/item/main.do', '2019-06-07 14:38:03', '2019-06-07 14:38:03');
INSERT INTO `sys_module_power_method` VALUES (92, 50, 'pers.chanus.yuntao.manager.controller.DictItemController', '/system/dict/item/list.do', '2019-06-07 14:38:26', '2019-06-07 14:38:26');
...
CREATE TABLE `sys_param` (
  ...
  `remark` varchar(200) DEFAULT '' COMMENT '备注',
  `valid_status` char(1) NOT NULL DEFAULT '1' COMMENT '状态：0-停用，1-启用',
  `modified_role_id` varchar(100) DEFAULT '' COMMENT '可以看到该参数的角色，多个角色用‘,’隔开，为空则所有角色都可以看到',
  `priority` int(10) unsigned NOT NULL COMMENT '优先级',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES (1, '0', '0', '超级管理员', '-1', '1', '1', '1', '具有所有权限', 1, '2018-09-02 18:03:45', '2018-09-02 18:55:26');
INSERT INTO `sys_role` VALUES (2, '1', '1', '子账号', '-1', '1', '1', '1', '子账号', 99, '2018-09-02 18:03:45', '2018-09-02 18:55:29');
INSERT INTO `sys_role` VALUES (3, '10', '10', '系统操作员', '0', '1', '1', '1', '', 1, '2018-09-02 18:03:45', '2018-09-02 18:55:34');
COMMIT;
...
BEGIN
  DECLARE parentRoleId varchar(50) DEFAULT '';
  DECLARE parentRoles varchar(1000) DEFAULT CONCAT(',', roleId, ',');
