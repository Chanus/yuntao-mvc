...
public class UrlUtils {
	 ...
	 * @since 0.0.1
	 */
	public final static Map<String, String> getParamsMap(String query, String duplicate) {
	 ...
	 * @since 0.0.1
	 */
	public final static String getParamsUri(Map<String, Object> params) {
	 ...
	 * @since 0.0.8
	 */
	public final static String getParamValue(String url, String paramName) {
	 ...
	 * @since 0.0.8
	 */
	public final static String removeParam(String url, String paramName) {
		int temp_index = url.indexOf("?");
		if (temp_index != -1) {
			int param_index = url.indexOf(paramName + "=", temp_index + 1);
			if (param_index != -1) {
	 ...
	 * @since 0.0.8
	 */
	public final static String removeParam(String url, String... paramNames) {
